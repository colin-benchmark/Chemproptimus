...
static void csp_id1_prepend(csp_packet_t *packet) {
    ...
    uint32_t id1
        = ((packet->id.pri << CSP_ID1_PRIO_OFFSET) | (packet->id.dst << CSP_ID1_DST_OFFSET)
           | (packet->id.src << CSP_ID1_SRC_OFFSET) | (packet->id.dport << CSP_ID1_DPORT_OFFSET)
           | (packet->id.sport << CSP_ID1_SPORT_OFFSET) | (packet->id.flags << CSP_ID1_FLAGS_OFFSET));
...
static void csp_id2_prepend(csp_packet_t *packet) {
    ...
    uint64_t id2
        = ((((uint64_t)packet->id.pri) << CSP_ID2_PRIO_OFFSET) | (((uint64_t)packet->id.dst) << CSP_ID2_DST_OFFSET)
           | (((uint64_t)packet->id.src) << CSP_ID2_SRC_OFFSET) | (packet->id.dport << CSP_ID2_DPORT_OFFSET)
           | (packet->id.sport << CSP_ID2_SPORT_OFFSET) | (packet->id.flags << CSP_ID2_FLAGS_OFFSET));
